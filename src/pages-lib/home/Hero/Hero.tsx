	...
	},
	{
		svg: (
			...
			>
				<path
					fill="#777E91"
					d="M17.401 24H8.21v-2.553H6.76a3.594 3.594 0 01-3.344-2.317l-.536-1.436a.51.51 0 00-.479-.332h-.319A1.531 1.531 0 01.57 15.575c.122-.728.792-1.277 1.564-1.277h1.15a2.554 2.554 0 012.348 1.544l.606 1.411c.161.376.53.62.939.62H8.21c.09-1.252.504-2.241 1.212-2.937l.14-.134C6.32 13.73 4.126 11.1 4.126 8.17a6.185 6.185 0 011.02-3.37V2.674c0-.83.193-1.65.563-2.393L5.854 0h.881a4.06 4.06 0 012.892 1.194l.242.242a10.544 10.544 0 015.886 0l.242-.242A4.06 4.06 0 0118.882 0h.88l.141.28c.37.745.562 1.564.562 2.394V4.8c.66 1 1.015 2.172 1.021 3.37 0 2.93-2.195 5.56-5.438 6.632l.121.121a4.111 4.111 0 011.232 2.924V24zm-8.17-1.021h7.149v-5.132a3.083 3.083 0 00-.926-2.19l-1.417-1.385.907-.21c3.249-.766 5.521-3.185 5.521-5.892a5.183 5.183 0 00-.932-2.93l-.09-.127V2.674c.001-.567-.11-1.128-.325-1.653h-.236c-.812 0-1.591.324-2.164.9l-.69.683-.3-.102a9.5 9.5 0 00-5.846 0l-.3.102-.69-.683a3.044 3.044 0 00-2.163-.9h-.236a4.354 4.354 0 00-.326 1.653v2.439l-.09.128c-.599.86-.924 1.88-.931 2.93 0 2.706 2.272 5.125 5.521 5.884l.906.21-1.436 1.405c-.53.517-.836 1.283-.912 2.285a1.021 1.021 0 01-1.015.939H7.176a2.043 2.043 0 01-1.877-1.239l-.6-1.41a1.532 1.532 0 00-1.41-.926h-1.15c-.274 0-.517.185-.555.421a.51.51 0 00.498.6h.313c.639.002 1.21.398 1.436.996l.536 1.43a2.566 2.566 0 002.394 1.66H8.21c.564 0 1.021.457 1.021 1.02v1.533z"
				></path>
			</svg>
		),
		link: 'https://twitter.com/IKreisz',
